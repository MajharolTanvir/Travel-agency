...
const getAllRoom = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            OR: room_constant_1.roomSearchAbleField.map(field => ({
                [field]: {
                    contains: searchTerm,
                    mode: 'insensitive',
                },
    ...
    const room = yield prisma_1.prisma.room.findMany({
...
const updateRoom = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    const room = yield prisma_1.prisma.room.update({
        where: {
            id,
        },
        data,
...
const deleteRoom = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const room = yield prisma_1.prisma.room.delete({
        where: {
            id,
        },
    });
