...
router.get('/', (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.HEAD_MANAGER, user_1.ENUM_USER_ROLE.TRAVELER), roomFacilities_controller_1.RoomFacilitiesController.getAllRoomFacilities);
router.get('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.HEAD_MANAGER, user_1.ENUM_USER_ROLE.TRAVELER), roomFacilities_controller_1.RoomFacilitiesController.getSingleRoomFacilities);
